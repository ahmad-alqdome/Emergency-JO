...
import kotlinx.android.synthetic.main.activity_saftey2.*
import kotlinx.android.synthetic.main.activity_user_setting.*
import kotlinx.android.synthetic.main.header_side_list.view.*

class Saftey2 : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    {
        val actionToggle= ActionBarDrawerToggle(this,drawer_safety2_id,toolbar,R.string.drawer_open,R.string.drawer_close)
        drawer_safety2_id.addDrawerListener(actionToggle)
    ...
    override fun onBackPressed() {
        if(drawer_safety2_id.isDrawerOpen(GravityCompat.START))
            closeDrawer()
        else
            super.onBackPressed()
    }
    ...
    {
        drawer_safety2_id.closeDrawer(GravityCompat.START)
